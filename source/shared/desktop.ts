import { RECONSTRUCTED_URL_SCHEME } from "./reconstructed-identity.js";
...
export function buildSandPluginDeepLink(pluginId: string): string { return `${RECONSTRUCTED_URL_SCHEME}://app${SAND_PLUGIN_DEEP_LINK_PATH}?id=${encodeURIComponent(pluginId)}`; }
